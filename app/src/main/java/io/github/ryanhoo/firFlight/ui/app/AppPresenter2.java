...
/**
 * Created with Android Studio. User: ryan.hoo.j@gmail.com Date: 8/21/16 Time: 10:23 PM Desc:
 * AppPresenter
 */
/* package */ class AppPresenter2 implements AppContract.Presenter {
    ...
    /* package */ AppPresenter2(AppRepository repository, AppContract.View view) {
        mRepository = repository;
        mView = view;
        DOWNLOAD_DIR = view.getContext().getFilesDir();
